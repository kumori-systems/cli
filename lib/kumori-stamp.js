...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield workspace_1.workspace.configManager.addStamp(name, config, isDefault);
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        let stampsInfo = workspace_1.workspace.configManager.getStampsInformation(stamp);
        let callbacks = [];
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield workspace_1.workspace.configManager.removeStamp(name);
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield workspace_1.workspace.configManager.updateStamp(name, config);
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield workspace_1.workspace.configManager.setDefaultStamp(name);
