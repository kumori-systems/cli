...
let defaultDomain = workspace_1.workspace.components.configManager.config.domain;
let defaultTemplate = workspace_1.workspace.components.configManager.config.service.template;
let defaultStamp = workspace_1.workspace.components.configManager.config.defaultStamp.name;
program
    .command('add <name>')
