        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.code && (error.code.localeCompare('ECONNREFUSED') == 0)) {
                    ...
                    error.message = `Authentication error. Please check you have set the authentication token for stamp ${stamp}. You can get your token from your user settings in the platform dashboard.`;
                }
                else {
