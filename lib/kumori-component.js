...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        let componentPath = yield index_1.workspace.components.build(name, companyDomain);
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        if (!componentVersion) {
            componentVersion = index_1.workspace.components.getCurrentVersion(name, companyDomain);
        }
