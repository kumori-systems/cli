...
let defaultTemplate = index_1.workspace.components.configManager.config.deployment.template;
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        if (!serviceVersion) {
            serviceVersion = index_1.workspace.services.getCurrentVersion(name, companyDomain);
...
program
    ...
    utils_1.run(() => __awaiter(this, void 0, void 0, function* () {
        ...
        let data = yield index_1.workspace.deployments.deploy(name, stamp);
        if (data.deployments) {
...
//# sourceMappingURL=kumori-deployment.js.map