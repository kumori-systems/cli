...
class Workspace {
    constructor() {
        ...
        this.config = new workspace_manager_1.WorkspaceConfigManager(WORKSPACE_CONFIG_FILE);
        this.components = new component_manager_1.ComponentManager(this.config, 'components');
        this.deployments = new deployment_manager_1.DeploymentManager(this.config, 'deployments');
        this.resources = new resource_manager_1.ResourceManager(this.config, 'resources');
        this.runtimes = new runtime_manager_1.RuntimeManager(this.config, 'runtimes');
        this.services = new service_manager_1.ServiceManager(this.config, 'services');
    }
    isValidWorkspace() {
